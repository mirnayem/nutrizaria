...
export class BlogsController {
  ...
  @Get() findAll(@Query() query: QueryBlogDto) { return this.blogsService.findAll(query); }
...
export class AdminBlogsController {
  constructor(private readonly blogsService: BlogsService) {}
  @Get() findAll(@Query() query: QueryBlogDto) { return this.blogsService.findAllAdmin(query); }
