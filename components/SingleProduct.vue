...
<template>
  <article
    class="group flex flex-col rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm transition hover:-translate-y-1 hover:shadow-lg"
  >
    ...
    <div class="mt-4 flex flex-1 flex-col gap-2 text-sm text-slate-500">
      ...
      <div class="mt-auto flex items-center justify-between pt-4">
        ...
        <button
          type="button"
          class="rounded-full border border-slate-200 px-4 py-2 text-xs font-semibold uppercase tracking-wide text-slate-600 transition hover:border-violet-500 hover:text-violet-600"
          @click="openModal"
        >
          Quick look
        </button>
      ...
      <div class="mt-3 flex flex-col gap-2">
        <button
          type="button"
          class="flex items-center justify-center gap-2 rounded-xl bg-violet-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-violet-500"
        ...
        <NuxtLink
          :to="detailLink"
          class="flex items-center justify-center rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:border-violet-500 hover:text-violet-700"
        >
          View details
        </NuxtLink>
      </div>
