...
<template>
  <aside class="w-64 shrink-0 border-r border-slate-200 bg-white">
    ...
    >
      ...
      <NuxtLink
        to="/featured"
        class="flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-slate-700 transition hover:bg-amber-50 hover:text-amber-700 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
        ...
        >
          ...
          <path
            stroke-linecap="round"
            stroke-linejoin="round"
            d="m11.48 3.499 1.04 5.111 5.518.442-4.204 3.602 1.285 5.385-4.725-2.885-4.725 2.885 1.285-5.385-4.204-3.602 5.518-.442z"
          />
        </svg>
        Featured products
      </NuxtLink>
